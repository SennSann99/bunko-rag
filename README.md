...
```
User Query → Embedding (BGE-M3) → Vector Search → Context → LLM (Qwen 3) → Answer
```

| コンポーネント | 技術 | 役割 |
|---|---|---|
| LLM | Qwen 3 8B (Ollama) | 日本語回答生成 |
...
| `LLM_MODEL` | `qwen3:8b` | 回答生成に使う LLM |
...
- [Qwen 3](https://qwenlm.github.io/blog/qwen3/) — 日本語対応 LLM
